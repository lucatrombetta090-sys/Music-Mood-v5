...
class MainActivity : AppCompatActivity() {
    ...
    private fun onPermissionGranted() {
        ...
        bottomNav.setOnItemSelectedListener { item ->
            when (item.itemId) {
                R.id.nav_library -> {
                    swapFragment(LibraryFragment(), R.string.nav_library); true
                }
                R.id.nav_stats   -> {
                    swapFragment(StatsFragment(), R.string.nav_stats); true
                }
                R.id.nav_profile -> {
                    swapFragment(ProfileFragment(), R.string.nav_profile); true
                }
                else -> false
            }
        }
    ...
    private fun handleDrawerSelection(itemId: Int) {
        when (itemId) {
            R.id.drawer_library   -> swapFragment(LibraryFragment(), R.string.nav_library)
            R.id.drawer_bubblemap -> swapFragment(BubbleMapFragment(), R.string.nav_bubblemap)
            R.id.drawer_stats     -> swapFragment(StatsFragment(), R.string.nav_stats)
            R.id.drawer_profile   -> swapFragment(ProfileFragment(), R.string.nav_profile)
            R.id.drawer_weekly    -> swapFragment(WeeklyReportFragment(), R.string.drawer_weekly)
            R.id.drawer_settings  -> swapFragment(SettingsFragment(), R.string.drawer_settings)
